...
with col1:
    st.image("/Users/shraddhadarade/Desktop/PROJECTS WINTER BREAK/Student Projects/Shivansh/Shiv.jpeg")
with col2:
...
with col3:
    st.image("/Users/shraddhadarade/Desktop/PROJECTS WINTER BREAK/Student Projects/Shivansh/aaibaba.jpeg")

with col4:
    st.title("My Mom and Dad")
    content2="""My Aai is a computer engineer, and she works at IBM. She’s so smart and always helps me learn new things. Aai also cooks the yummiest food for me—I love everything she makes! She gives me the best hugs, and I love her so much. 💖
